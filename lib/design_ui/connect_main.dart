  ...
  List<Map> data = [
    ...
    },
    {
      ...
      "message": {
        ...
        "description": "I'm really excited to work for Smartchainers pvt, starting from next week.",
      }
    },
    {
      "imageUrl":
      ...
      "message": {
        "title": "MCA",
        "description": "Joined MCA in RVS college one of the best college in Coimbatore also where i did my UG.",
      }
    },
  ];
